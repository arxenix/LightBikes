 ...
 * Time: 10:05 PM
 */
public class EntityBike extends EntityCreature {
    ...
    @Override
    public ItemStack be() {return null;}

    @Override
    public ItemStack getEquipment(int i) {return null;}

    @Override
    public void setEquipment(int i, ItemStack itemStack) {    }

    @Override
    public ItemStack[] getEquipment() {return new ItemStack[0];}
}
